...
btnReset  = Button(RightFrame2, text="Reset", font=('quicksand 26 bold'), height = 3, width = 21, bg="gainsboro",command=reset)
btnReset.grid(row=0, column=0, padx=6, pady=11)

btnNewGame  = Button(RightFrame2, text="New Game", font=('quicksand 26 bold'), height = 3, width = 21, bg="gainsboro", command=NewGame)
